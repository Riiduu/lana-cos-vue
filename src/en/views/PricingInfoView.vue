        ...
        <div id="hidable">
            ...
            <div class="content">
                <div class="prices">
                    ...
                    ><br />
                    <label id="list-option">Thursday - 09:00-18:00</label><br />
                    <label id="list-option">Friday - 09:00-18:00</label><br />
                    <label id="list-option">Saturday - Suljettu</label><br />
                    <label id="list-option">Sunday - Suljettu</label><br />
                </div>
            </div>
        </div>
    </div>
